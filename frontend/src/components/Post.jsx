    ...
    <div className="flex flex-col lg:flex-row lg:items-center gap-3 post">
      ...
      <div className="w-[100%] lg:w-[25rem]">
        <div className=" flex items-center gap-10">
          ...
          <span className="text-gray-400 text-sm">{post.time_since_created} ago</span>
          <span className="bg-red-700 px-3 py-1 rounded-[0.1rem] font-bold text-white text-sm">{post.category}</span>
        </div>
        <h2 className="font-bold text-lg mt-2">{post.title}</h2>
        <p className="mt-3  leading-8 text-gray-500 font-medium">
          {post.content}
          {/* <Button className="bg-slate-800 border-0 hover:bg-slate-700">read more</Button> */}
        </p>
